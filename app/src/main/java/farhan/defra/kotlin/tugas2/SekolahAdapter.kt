...
class LinearRecyclerSekolahActivity : AppCompatActivity() {
    ...
    private fun setBerita() {
        ...
        val beritaAdapter = BeritaAdapter(berita, object : BeritaAdapter.OnAdapterListener {
            override fun onClick(result: BeritaModel) {
                ...
                val intent = Intent(this@LinearRecyclerSekolahActivity, DetailBeritaActivity::class.java)
                intent.putExtras(bundle)
                startActivity(intent)
            }
        })

        rvSekolah.adapter = beritaAdapter
    }
}
